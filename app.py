...
if st.session_state.pairs:
    ...
    with st.expander(f"Price Ratio"):
        ...
        fig.add_hline(y=mean_ratio, line_dash="dot", line_color="#F2F2F2", line_width=1)
        fig.add_annotation(
        ...
        fig.add_hline(y=lower_bound, line_dash="solid", line_color="#F2F2F2", line_width=1)
        fig.add_annotation(
        ...
        fig.add_hline(y=upper_bound, line_dash="solid", line_color="#F2F2F2", line_width=1)
        fig.add_annotation(
